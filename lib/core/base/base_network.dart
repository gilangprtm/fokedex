...
abstract class BaseService {
    ...
    return performanceService.measureAsync(
      ...
      () async {
        ...
        try {
          ...
          logger.e('Error in cached operation for $cacheKey',
              error: e, stackTrace: stackTrace, tag: serviceTag);
          rethrow;
        }
      },
      tag: serviceTag,
  ...
  Future<bool> clearCache(String cacheKey, {String? tag}) async {
    try {
      ...
      logger.e('Error clearing cache for $cacheKey',
          error: e, tag: tag ?? "Service");
      return false;
    }
  }
